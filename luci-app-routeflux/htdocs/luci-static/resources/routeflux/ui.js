...
return baseclass.extend({
	...
	renderSharedStyles: function() {
		return E('style', { 'type': 'text/css' }, [
			...
			'.routeflux-page-shell .cbi-button, .routeflux-button-primary, .routeflux-button-secondary, .routeflux-button-danger { display:inline-flex; align-items:center; justify-content:center; min-height:46px; padding:0 18px; border:1px solid rgba(145, 175, 220, 0.18); border-radius:16px; background:rgba(15, 24, 38, 0.82); color:var(--routeflux-text-primary); box-shadow:0 12px 24px rgba(0, 0, 0, 0.18), inset 0 1px 0 rgba(255, 255, 255, 0.03); transition:transform .16s ease, border-color .16s ease, box-shadow .16s ease, background .16s ease, color .16s ease; }',
			'.routeflux-page-shell .cbi-button:hover, .routeflux-button-primary:hover, .routeflux-button-secondary:hover, .routeflux-button-danger:hover { transform:translateY(-1px); border-color:rgba(145, 190, 246, 0.28); box-shadow:0 16px 26px rgba(0, 0, 0, 0.22), inset 0 1px 0 rgba(255, 255, 255, 0.04); }',
			'.routeflux-page-shell .cbi-button:focus, .routeflux-button-primary:focus, .routeflux-button-secondary:focus, .routeflux-button-danger:focus { outline:none; border-color:rgba(88, 196, 255, 0.56); box-shadow:0 0 0 1px rgba(88, 196, 255, 0.18), 0 0 0 8px rgba(88, 196, 255, 0.06); }',
			'.routeflux-page-shell .cbi-button[disabled], .routeflux-page-shell .cbi-button:disabled, .routeflux-button-primary[disabled], .routeflux-button-secondary[disabled], .routeflux-button-danger[disabled] { opacity:.46; cursor:not-allowed; transform:none; box-shadow:none; }',
			'.routeflux-page-shell .cbi-button-apply, .routeflux-button-primary { border-color:rgba(88, 196, 255, 0.34); background:linear-gradient(180deg, rgba(52, 147, 235, 0.92) 0%, rgba(30, 116, 211, 0.94) 100%); color:#f4fbff; box-shadow:0 18px 32px rgba(30, 116, 211, 0.24), inset 0 1px 0 rgba(255, 255, 255, 0.14); }',
			'.routeflux-page-shell .cbi-button-action, .routeflux-button-secondary { border-color:rgba(120, 160, 214, 0.2); background:rgba(12, 20, 34, 0.82); color:#a8d7ff; }',
			'.routeflux-page-shell .cbi-button-negative, .routeflux-page-shell .cbi-button-reset, .routeflux-button-danger { border-color:rgba(255, 123, 140, 0.28); background:rgba(52, 16, 26, 0.82); color:#ffb7c0; box-shadow:0 16px 28px rgba(52, 16, 26, 0.24), inset 0 1px 0 rgba(255, 255, 255, 0.05); }',
			...
			'.routeflux-theme-light .routeflux-surface, .routeflux-theme-light .routeflux-page-shell .cbi-section { background:linear-gradient(180deg, rgba(250, 252, 254, 0.98) 0%, rgba(243, 247, 251, 0.98) 100%); border-color:rgba(125, 146, 170, 0.18); box-shadow:0 16px 30px rgba(63, 87, 118, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.84); }',
			'.routeflux-theme-light .routeflux-surface::before, .routeflux-theme-light .routeflux-page-shell .cbi-section::before { background:linear-gradient(90deg, rgba(14, 165, 233, 0.28) 0%, rgba(14, 165, 233, 0.08) 42%, rgba(14, 165, 233, 0) 100%); }',
			...
			'.routeflux-theme-light .routeflux-page-shell .table, .routeflux-theme-light .routeflux-data-table { border-color:rgba(125, 146, 170, 0.16); background:rgba(249, 251, 253, 0.9); }',
			'.routeflux-theme-light .routeflux-page-shell .table .th, .routeflux-theme-light .routeflux-data-table .th { background:rgba(125, 146, 170, 0.06); }',
			'.routeflux-theme-light .routeflux-page-shell .table .tr:hover .td, .routeflux-theme-light .routeflux-data-table .tr:hover .td { background:rgba(14, 165, 233, 0.04); }',
			'.routeflux-theme-light .routeflux-page-shell .label { border-color:rgba(106, 133, 164, 0.16); background:rgba(255, 255, 255, 0.9); color:var(--routeflux-text-secondary); }',
			'.routeflux-theme-light .routeflux-page-shell .cbi-input-text, .routeflux-theme-light .routeflux-page-shell .cbi-input-textarea, .routeflux-theme-light .routeflux-page-shell select, .routeflux-theme-light .routeflux-page-shell textarea, .routeflux-theme-light .routeflux-page-shell input[type="text"], .routeflux-theme-light .routeflux-page-shell input[type="number"] { border-color:rgba(125, 146, 170, 0.18); background:linear-gradient(180deg, rgba(249, 251, 253, 0.96) 0%, rgba(243, 247, 251, 0.96) 100%); box-shadow:inset 0 1px 0 rgba(255, 255, 255, 0.86), 0 6px 16px rgba(63, 87, 118, 0.05); }',
			'.routeflux-theme-light .routeflux-page-shell .cbi-input-text:focus, .routeflux-theme-light .routeflux-page-shell .cbi-input-textarea:focus, .routeflux-theme-light .routeflux-page-shell select:focus, .routeflux-theme-light .routeflux-page-shell textarea:focus, .routeflux-theme-light .routeflux-page-shell input:focus { border-color:rgba(37, 99, 235, 0.4); box-shadow:0 0 0 1px rgba(37, 99, 235, 0.12), 0 0 0 6px rgba(37, 99, 235, 0.04); }',
			...
			'.routeflux-theme-light .routeflux-page-shell .cbi-button, .routeflux-theme-light .routeflux-button-primary, .routeflux-theme-light .routeflux-button-secondary, .routeflux-theme-light .routeflux-button-danger { border-color:rgba(125, 146, 170, 0.16); background:linear-gradient(180deg, rgba(250, 252, 254, 0.98) 0%, rgba(241, 246, 251, 0.98) 100%); color:var(--routeflux-text-primary); box-shadow:0 10px 20px rgba(63, 87, 118, 0.08), inset 0 1px 0 rgba(255, 255, 255, 0.88); }',
			'.routeflux-theme-light .routeflux-page-shell .cbi-button:hover, .routeflux-theme-light .routeflux-button-primary:hover, .routeflux-theme-light .routeflux-button-secondary:hover, .routeflux-theme-light .routeflux-button-danger:hover { border-color:rgba(37, 99, 235, 0.22); box-shadow:0 12px 22px rgba(63, 87, 118, 0.1), inset 0 1px 0 rgba(255, 255, 255, 0.9); }',
			'.routeflux-theme-light .routeflux-page-shell .cbi-button-apply, .routeflux-theme-light .routeflux-button-primary { border-color:rgba(37, 99, 235, 0.34); background:linear-gradient(180deg, #2563eb 0%, #1d4ed8 100%); color:#f8fbff; box-shadow:0 14px 28px rgba(37, 99, 235, 0.18), inset 0 1px 0 rgba(255, 255, 255, 0.16); }',
			'.routeflux-theme-light .routeflux-page-shell .cbi-button-apply:hover, .routeflux-theme-light .routeflux-button-primary:hover { border-color:rgba(29, 78, 216, 0.42); background:linear-gradient(180deg, #1d4ed8 0%, #1e40af 100%); color:#ffffff; box-shadow:0 16px 30px rgba(29, 78, 216, 0.22), inset 0 1px 0 rgba(255, 255, 255, 0.18); }',
			...
			'.routeflux-theme-light .routeflux-page-shell .cbi-button-negative, .routeflux-theme-light .routeflux-page-shell .cbi-button-reset, .routeflux-theme-light .routeflux-button-danger { border-color:rgba(220, 38, 38, 0.18); background:linear-gradient(180deg, rgba(253, 246, 246, 0.98) 0%, rgba(249, 237, 237, 0.98) 100%); color:#b91c1c; box-shadow:0 12px 22px rgba(127, 29, 29, 0.06), inset 0 1px 0 rgba(255, 255, 255, 0.9); }',
			'.routeflux-theme-light .routeflux-page-shell .alert-message, .routeflux-theme-light .routeflux-page-shell .routeflux-page-banner { background:rgba(255, 255, 255, 0.88); border-color:rgba(106, 133, 164, 0.16); color:var(--routeflux-text-secondary); }',
			'.routeflux-theme-light .routeflux-page-shell .alert-message.notice, .routeflux-theme-light .routeflux-page-shell .routeflux-page-banner-info { background:rgba(239, 248, 255, 0.94); color:#075985; border-color:rgba(56, 189, 248, 0.2); }',
			'.routeflux-theme-light .routeflux-page-shell .alert-message.warning, .routeflux-theme-light .routeflux-page-shell .routeflux-page-banner-warning { background:rgba(254, 242, 242, 0.96); color:#b91c1c; border-color:rgba(239, 68, 68, 0.2); }',
