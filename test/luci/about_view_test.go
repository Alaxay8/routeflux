...
func TestAboutViewExposesWhatsNewTab(t *testing.T) {
	...
	for _, want := range []string{
		...
		"Firewall mode drafts and target bundles",
		"LuCI now keeps separate saved selector sets for Targets, Hosts, and Anti-target modes, and custom target aliases can include other service aliases to build reusable bundles.",
		"v0.1.5",
